...
public class ReviewController {
    ...
    public ResponseEntity<ApiResponse<ReviewResponse>> createReview(
        ...
        return ResponseEntity.status(201).body(ApiResponse.onSuccess(toResponse(review)));
    }
    ...
    public ResponseEntity<ApiResponse<List<ReviewResponse>>> getReviewsByPostId(@PathVariable Long postId) {
