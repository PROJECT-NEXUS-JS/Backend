...
@Schema(description = "피드백 최종 제출 요청")
public record FeedbackSubmitRequest(
        ...
        @NotNull(message = "전반적인 만족도는 필수입니다.")
        ...
        @NotNull(message = "버그 존재 여부는 필수입니다.")
        Boolean hasBug,
        ...
        @NotNull(message = "가이드 이해도는 필수입니다.")
